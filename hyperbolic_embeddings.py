...
class HyperbolicEmbeddings:
    ...
    def _load_model(self, embedding_type, config) -> BaseHyperbolicModel:
        ...
        elif embedding_type == "lorentz_embeddings":
    ...
    def plot_embeddings(self, labels: Optional[List[str]] = None, save_path: Optional[str] = None):
        ...
        ax.scatter(x, y, s=50, edgecolor="black", color="skyblue")
        ...
        if labels:
            ...
            for label in unique_labels:
                ...
                ax.scatter(x[indices], y[indices], s=50, edgecolor="black", color=label_to_color[label], label=label)
