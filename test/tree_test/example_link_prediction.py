...
def main():
    ...
    graph = create_test_tree_graph(branching_factor=2, depth=3)
    ...
    plt.title("Original Test Tree Graph")
    plt.show()
    ...
    # Print results
    print("\nResults:")
    print(f"Predicted {len(predicted_links)} links")
    print(f"Total edges in original graph: {len(all_edges)}")
    print("\nMetrics:")
