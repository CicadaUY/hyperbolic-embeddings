python -m test.other.link_prediction --embedding_type="poincare_maps" --q=0.9 --dataset="Olsson"
python -m test.other.link_prediction --embedding_type="poincare_embeddings" --q=0.9 --dataset="Olsson"
python -m test.other.link_prediction --embedding_type="dmercator" --q=0.9 --dataset="Olsson"
python -m test.other.link_prediction --embedding_type="hydra" --q=0.9 --dataset="Olsson"
python -m test.other.link_prediction --embedding_type="hydra_plus" --q=0.9 --dataset="Olsson"
python -m test.other.link_prediction --embedding_type="hypermap" --q=0.9 --dataset="Olsson"
